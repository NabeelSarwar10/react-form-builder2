...
var Toolbar = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Toolbar, [{
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/_react["default"].createElement("h4", null, "Primitives"), 
      /*#__PURE__*/_react["default"].createElement("ul", null, this.state.items.filter(k=>k.type==='premitives').map(function (item) {
      ...
      })), /*#__PURE__*/_react["default"].createElement("h4", null, "Pre-built"),
      _react["default"].createElement("ul", null, this.state.items.filter(k=>k.type==='prebuilt').map(function (item) {
        return /*#__PURE__*/_react["default"].createElement(_toolbarDraggableItem["default"], {
          data: item,
          key: item.key,
          onClick: _this2._onClick.bind(_this2, item),
